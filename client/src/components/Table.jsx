        ...
        <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
            <thead className="ltr:text-left rtl:text-right">
                <tr>
                    ...
                    <th className="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Tipo de usuario</th>
        ...
        
        {
         users.map((user)=> (
            <tr key={user.id}>
                ...
                {user.user_type === 0 ? 'Estudiante' : user.user_type === 1 ? 'Profesor' : user.user_type === 2 ? 'Administrador' : 'Desconocido'}
                </td>
